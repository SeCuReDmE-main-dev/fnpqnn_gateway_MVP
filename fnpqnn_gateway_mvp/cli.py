...
def build_parser() -> argparse.ArgumentParser:
    ...
    natural.add_argument("provider", choices=["openai", "google", "github-copilot"])
    ...
    provider.add_argument("provider", choices=["openai", "google", "github-copilot"])
    ...
    support_provider_parser.add_argument("provider", choices=["openai", "google", "github-copilot"])
